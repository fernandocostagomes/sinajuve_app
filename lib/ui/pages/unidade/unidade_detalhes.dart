...
class UnidadeDetalhes {
  ...
  UnidadeDetalhes.fromJson(Map<String, dynamic> json) {
  ...
  void save() {
    ...
    Prefs.setString("unidade_detalhes.prefs", json);
  }

  static Future<UnidadeDetalhes> get() async {
    String json = await Prefs.getString("unidade_detalhes.prefs");
    if (json.isEmpty) {
      return null;
    }
    Map map = convert.json.decode(json);
    UnidadeDetalhes adesao = UnidadeDetalhes.fromJson(map);
    return adesao;
  }

  static void clear() {
    Prefs.setString("unidade_detalhes.prefs", "");
  }
}
